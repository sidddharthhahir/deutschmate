 ...
 *
 * The whole page exists because of one decision: the course is free and runs on
 * this machine, and the four features that need a model run on YOUR credential.
 * Nobody can spend anybody else's, this install's bill does not grow with the
 * number of people on it, and anyone who never adds a key still gets the entire
 * course minus four things — each of which already degrades honestly.
 */
    ...
    <main className="flex min-h-screen flex-col">
      ...
      <div className="mx-auto w-full max-w-[620px] flex-1 px-6 py-10 md:px-10">
        ...
        <p className="text-secondary mt-3 text-[15px] leading-relaxed">
          Der Kurs ist kostenlos und läuft auf diesem Rechner. Vier Dinge brauchen ein
          Modell — und dafür deinen eigenen Schlüssel.
        </p>

        <KeyForm state={key} spend={spend.dollars} cap={cap} isDefault={isDefault} />
        ...
        <section className="border-line-sub mt-12 border-t pt-6">
          ...
          <div className="space-y-2.5 text-[14px]">
            {[
              ["Gespräch", "läuft als vorbereiteter Dialog statt als freies Gespräch"],
              ["Schreibkorrektur", "dein Text wird gespeichert und korrigiert, sobald ein Schlüssel da ist"],
              ["„Erklär mir das“", "aus dem Cache, wenn es jemand schon gefragt hat"],
          ...
          <p className="text-muted mt-4 max-w-[56ch] text-[12.5px] leading-relaxed">
            Alles andere kostet nichts und braucht nichts: 2.400 Wörter mit Audio, 120
            Units, 36 Grammatikpunkte, 38 Lesetexte, Wiederholungen, Lücken, Tests,
            Minimalpaare, Unterwegs — und 955 fertige Erklärungen, sodass jede falsche
        ...
        <p className="text-muted/70 mt-10 text-[12px] leading-relaxed">
          ...
          angezeigt — auch dir nicht. Er verlässt diesen Server nur Richtung Anthropic.
        </p>
      </div>
    </main>
  );
