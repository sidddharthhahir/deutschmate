 ...
 *
 * Mounted once in the header so it exists on every page, and deliberately not
 * a nav item: the design holds the header at exactly four targets, and a fifth
 * would start turning Home into a menu. A palette adds reach without adding
 * anything to look at.
 */
            ...
            list.map((h, n) => (
              ...
              >
                <span className="min-w-0">
                  <span className="font-serif text-fg text-[17px]">{h.label}</span>
